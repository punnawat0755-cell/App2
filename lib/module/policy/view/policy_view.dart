          ...
          child: Column(
            ...
            children: [
              ...
              _buildPolicyItem(
                ...
                onChanged: (val) => setState(() => isTermsAccepted = val ?? false),
              ),
                  ...
                  child: _isLoading
                      ...
                      : Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isAllAccepted ? Colors.white : Colors.white70,
                          ),
                        ),
                ),
              ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionText(
              'บันทึกการสนทนาระหว่างผู้ใช้งานจะถูกจัดเก็บเพื่อใช้ในการวิเคราะห์ พัฒนาคุณภาพการให้คำปรึกษา และรักษาความปลอดภัยของระบบตามความยินยอมของผู้ใช้งาน',
              contentColor,
            ),
            const SizedBox(height: 10),
            _buildHeader('2. วัตถุประสงค์ในการใช้ข้อมูล'),
            _buildBullet('เพื่อให้บริการฟังก์ชันหลักของแอปพลิเคชัน', contentColor),
            _buildBullet('เพื่อวิเคราะห์แนวโน้มสุขภาพและสุขภาวะทางใจ', contentColor),
            _buildBullet('เพื่อพัฒนาคุณภาพระบบจับคู่และการให้คำปรึกษา', contentColor),
            const SizedBox(height: 10),
            _buildHeader('3. การคุ้มครองข้อมูลส่วนบุคคล'),
            _buildSectionText(
              'เรามีมาตรการที่เหมาะสมในการเก็บรักษาและป้องกันการเข้าถึงข้อมูลโดยไม่ได้รับอนุญาต รวมถึงใช้ระบบยืนยันตัวตนและสิทธิ์การเข้าถึงตามบทบาท',
              contentColor,
            ),
          ],
        ),
  ...
  static Widget _buildBullet(String text, Color color) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('• ', style: TextStyle(color: Color(0xFF4A89D8))),
          Expanded(
            child: Text(
              text,
              style: TextStyle(fontSize: 14, color: color, height: 1.4),
