...
class QuizController extends GetxController {
  ...
  void generateRandomQuiz() {
    var shuffledList = List<Map<String, dynamic>>.from(allQuestions)..shuffle();
  ...
  void selectOption(int optionIndex, String text, int score) {
    ...
    Future.delayed(const Duration(milliseconds: 1000), () {
      if (currentQuestionIndex.value < 4) {
        ...
        // ครบ 5 ข้อ
        print("=== ข้อมูลสำหรับส่งให้ Backend จัดเทียร์ ===");
        print(userAnswersForBackend);
        print("คะแนนรวม: ${totalScore.value}");
